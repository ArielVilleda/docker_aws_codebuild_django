...
# IF ALLOWED_HOST NOT SPECIFIED IN .env FILE, THEN DEFAULT IS *
...
INSTALLED_APPS = [
    ...
    # storages app to use static assets
    'storages',
    'corsheaders',
    'rest_framework',
    'api',
...
MIDDLEWARE = [
    ...
    # CORS must be a first executed middleware
...
if os.environ.get('POSTGRES_SERVICE'):
    DATABASES = {
        'default': {
...
# Clear prev config (Disabling Django Loggin)
LOGGING_CONFIG = None
